...
const characters = [
  {
    ...
    stats: { intelligence: 6, strength: 6, speed: 5, durability: 6, energyProjection: 6, fightingSkills: 4 },
  ...
  },
  {
    ...
    powers: ["Sentido arácnido premonitorio", "Trepar muros y superficies", "Fuerza y agilidad sobrehumanas", "Lanzatelarañas biomecánicos", "Intelecto científico prodigio"],
    stats: { intelligence: 4, strength: 4, speed: 3, durability: 3, energyProjection: 1, fightingSkills: 5 },
    ...
    mcuAppearances: ["Captain America: Civil War (2016)", "Spider-Man: No Way Home (2021)"]
  },
  {
    id: 1009610,
    ...
    powers: ["Fuerza, velocidad y resistencia en el pináculo humano", "Maestría táctica inigualable", "Reflejos aumentados", "Escudo de vibranium indestructible"],
    stats: { intelligence: 3, strength: 3, speed: 2, durability: 3, energyProjection: 1, fightingSkills: 6 },
    ...
    notableComics: ["Captain America Lives! (2005)", "The Winter Soldier (2005)", "Civil War (2006)"],
    mcuAppearances: ["The First Avenger (2011)", "The Winter Soldier (2014)", "Avengers: Endgame (2019)"]
  },
  {
    id: 1009664,
    name: "Thor",
    ...
    powers: ["Fisiología divina asgardiana inmortal", "Control meteorológico y rayos místicos", "Fuerza clase 100+", "Vuelo y manipulación dimensional mediante Mjolnir/Stormbreaker"],
    stats: { intelligence: 2, strength: 7, speed: 6, durability: 6, energyProjection: 6, fightingSkills: 5 },
    thumbnail: { path: "https://i.annihil.us/u/prod/marvel/i/mg/d/d0/5269657a74350", extension: "jpg" },
    comicCover: "/images/thor-cover.jpg",
    notableComics: ["The Mighty Thor: Surtur Saga (1984)", "Thor: God of Thunder (2012)", "War of the Realms (2019)"],
  ...
  },
  {
    ...
    powers: ["Fuerza física potencialmente infinita", "Factor de curación regenerativo hiperacelerado", "Saltos transcontinentales", "Resistencia a temperaturas y ataques atómicos"],
    stats: { intelligence: 6, strength: 7, speed: 3, durability: 7, energyProjection: 1, fightingSkills: 4 },
    ...
    mcuAppearances: ["The Incredible Hulk (2008)", "The Avengers (2012)", "Avengers: Endgame (2019)"]
  },
  {
    id: 1009546,
    name: "Black Widow",
    ...
    powers: ["Maestra en artes marciales mixtas y asesinato táctico", "Condicionamiento físico al límite humano", "Experta en sigilo e interrogatorio", "Aguijones de Viuda (descargas eléctricas de 30.000V)"],
    stats: { intelligence: 3, strength: 2, speed: 2, durability: 2, energyProjection: 3, fightingSkills: 6 },
    thumbnail: { path: "https://i.annihil.us/u/prod/marvel/i/mg/f/30/50fecad1f16e3", extension: "jpg" },
    comicCover: "/images/blackwidow-cover.jpg",
    notableComics: ["Black Widow: The Coldest War (1990)", "Black Widow: Deadly Origin (2009)", "The Name of the Rose (2010)"],
    mcuAppearances: ["Iron Man 2 (2010)", "Captain America: The Winter Soldier (2014)", "Avengers: Endgame (2019)"]
  },
  {
    id: 1009718,
    name: "Wolverine",
    ...
    powers: ["Factor de regeneración celular mutante", "Esqueleto y garras retráctiles de adamantium", "Sentidos olfativos y auditivos hiperagudos", "Longevidad extendida y resistencia a toxinas"],
    stats: { intelligence: 2, strength: 4, speed: 2, durability: 4, energyProjection: 1, fightingSkills: 7 },
    ...
    notableComics: ["Weapon X (1991)", "Wolverine: Origin (2001)", "Old Man Logan (2008)"],
  ...
  },
  {
    ...
    powers: ["Hechicería mística universal", "Manipulación del tiempo y las dimensiones", "Teletransportación y proyección astral", "Artefactos arcanos (Ojo de Agamotto, Capa de Levitación)"],
    stats: { intelligence: 4, strength: 2, speed: 2, durability: 3, energyProjection: 6, fightingSkills: 3 },
    ...
    notableComics: ["Doctor Strange: The Oath (2006)", "A Separate Reality (1974)", "Damnation (2018)"],
  ...
  },
  {
    ...
    powers: ["Magia del Caos primordial", "Deformación y alteración de la realidad", "Telequinesis y campos de fuerza", "Proyección psiónica y transmutación de materia"],
    stats: { intelligence: 3, strength: 2, speed: 2, durability: 2, energyProjection: 6, fightingSkills: 3 },
    ...
    notableComics: ["Avengers Disassembled (2004)", "House of M (2005)", "Scarlet Witch (2016)"],
  ...
  },
  {
    ...
    powers: ["Fisiología sobrehumana otorgada por la Hierba Corazón", "Hábito de combate tejido con microfibra de Vibranium", "Garras de anti-metal capaces de cortar cualquier sustancia", "Estratega político y científico nivel genio"],
    stats: { intelligence: 5, strength: 3, speed: 2, durability: 3, energyProjection: 3, fightingSkills: 6 },
    thumbnail: { path: "https://i.annihil.us/u/prod/marvel/i/mg/6/60/5261a80a67e7d", extension: "jpg" },
    comicCover: "/images/blackpanther-cover.png",
    notableComics: ["Panther's Rage (1973)", "Black Panther by Christopher Priest (1998)", "A Nation Under Our Feet (2016)"],
  ...
  },
  {
    ...
    powers: ["Factor de curación regenerativo extremo e inmortalidad", "Consciencia de la 4ª pared y omnisciencia de medios", "Tirador y espadachín de nivel maestro", "Inmunidad total a ataques telepáticos debido a su inestabilidad mental"],
    stats: { intelligence: 2, strength: 4, speed: 2, durability: 4, energyProjection: 1, fightingSkills: 6 },
    ...
    notableComics: ["Deadpool Kills the Marvel Universe (2012)", "The Good, The Bad and The Ugly (2013)", "Cable & Deadpool (2004)"],
  ...
  },
  {
    ...
    powers: ["Fisiología de Eterno Titánico con invulnerabilidad extrema", "Manipulación de energía cósmica y mística", "Fuerza que rivaliza con Hulk y Thor juntos", "Maestría en el Guantelete del Infinito omnipotente"],
    stats: { intelligence: 6, strength: 7, speed: 7, durability: 6, energyProjection: 6, fightingSkills: 4 },
    thumbnail: { path: "https://i.annihil.us/u/prod/marvel/i/mg/6/40/5261a80a67e7d", extension: "jpg" },
    comicCover: "/images/thanos-cover.png",
    notableComics: ["The Thanos Quest (1990)", "The Infinity Gauntlet (1991)", "Thanos Wins (2017)"],
    mcuAppearances: ["The Avengers (2012)", "Avengers: Infinity War (2018)", "Avengers: Endgame (2019)"]
  },
  {
    id: 1009407,
    name: "Loki",
    ...
    powers: ["Ilusionismo e hipnosis de escala divina", "Hechicería y teletransportación asgardiana", "Fisiología de Gigante de Escarcha (resistencia y longevidad)", "Manipulación multiversal de líneas de tiempo"],
    stats: { intelligence: 5, strength: 4, speed: 3, durability: 4, energyProjection: 6, fightingSkills: 3 },
    thumbnail: { path: "https://i.annihil.us/u/prod/marvel/i/mg/d/90/526547f509313", extension: "jpg" },
    comicCover: "/images/loki-cover.png",
    notableComics: ["Thor: The Trials of Loki (2010)", "Journey into Mystery by Kieron Gillen (2011)", "Loki: Agent of Asgard (2014)"],
    mcuAppearances: ["Thor (2011)", "The Avengers (2012)", "Loki Serie Disney+ (2021-2023)"]
  },
  {
    id: 1010338,
    name: "Captain Marvel",
    ...
    powers: ["Manipulación y absorción de energía estelar fotónica", "Vuelo a velocidad relativista espacial", "Fuerza cósmica clase 100+", "Modo Binaria con capacidad destructiva supernova"],
    stats: { intelligence: 3, strength: 5, speed: 5, durability: 6, energyProjection: 5, fightingSkills: 4 },
    ...
    notableComics: ["Captain Marvel: In Pursuit of Flight (2012)", "The Death of Captain Marvel (1982)", "Civil War II (2016)"],
  ...
  },
  {
    ...
    powers: ["Sentido de radar 360 grados ecolocalizador", "Oído, tacto y olfato hiperagudos capaces de detectar pulsos cardíacos", "Maestro acróbata y pugilista ninja", "Bastón multifunción con cable de fibra de carbono"],
    stats: { intelligence: 3, strength: 2, speed: 2, durability: 2, energyProjection: 1, fightingSkills: 5 },
    thumbnail: { path: "https://i.annihil.us/u/prod/marvel/i/mg/d/d0/5269657a74350", extension: "jpg" },
    comicCover: "/images/daredevil-cover.png",
    notableComics: ["Born Again (1986)", "The Man Without Fear (1993)", "Guardian Devil (1998)", "Daredevil by Chip Zdarsky (2019)"],
  ...
  },
  {
    ...
    powers: ["Generación de zarcillos, telarañas oscuras y masa biológica", "Camuflaje mimético y sigilo", "Fuerza superior a Spider-Man e inmunidad al sentido arácnido", "Fauces y dientes afilados de alta letalidad"],
    stats: { intelligence: 3, strength: 4, speed: 2, durability: 4, energyProjection: 1, fightingSkills: 4 },
    thumbnail: { path: "https://i.annihil.us/u/prod/marvel/i/mg/5/a0/538615ca33ab0", extension: "jpg" },
    comicCover: "/images/venom-cover.png",
    notableComics: ["Venom: Lethal Protector (1993)", "Maximum Carnage (1993)", "Venom by Donny Cates (2018)", "King in Black (2020)"],
    mcuAppearances: ["Spider-Man 3 (2007)", "Venom (2018)", "Spider-Man: No Way Home (2021)"]
  },
  {
    id: 1009338,
    name: "Hawkeye",
    ...
    powers: ["Puntería perfecta e infalible", "Maestría en combate cuerpo a cuerpo y arquería táctica", "Arsenal de flechas trucadas (PEM, explosivas, sónicas, ácido)", "Estratega veterano de campo"],
    stats: { intelligence: 3, strength: 2, speed: 2, durability: 2, energyProjection: 1, fightingSkills: 6 },
    thumbnail: { path: "https://i.annihil.us/u/prod/marvel/i/mg/e/90/50fecaf4f101b", extension: "jpg" },
    comicCover: "/images/hawkeye-cover.png",
    notableComics: ["Hawkeye by Matt Fraction & David Aja (2012)", "Blindspot (2011)", "Old Man Hawkeye (2018)"],
    mcuAppearances: ["The Avengers (2012)", "Captain America: Civil War (2016)", "Hawkeye Serie Disney+ (2021)"]
  },
  {
    id: 1009297,
    name: "Falcon",
    ...
    powers: ["Arnés de vuelo con alas articuladas de vibranium", "Enlace empático y telepático con aves", "Maestría en combate aéreo y táctico", "Uso magistral del escudo del Capitán América"],
    stats: { intelligence: 2, strength: 2, speed: 3, durability: 2, energyProjection: 1, fightingSkills: 4 },
    thumbnail: { path: "https://i.annihil.us/u/prod/marvel/i/mg/f/b0/5111505fb7009", extension: "jpg" },
    comicCover: "/images/falcon-cover.png",
    notableComics: ["Captain America and the Falcon (2004)", "All-New Captain America (2014)", "Captain America: Sam Wilson (2015)"],
    mcuAppearances: ["Captain America: The Winter Soldier (2014)", "The Falcon and the Winter Soldier (2021)", "Captain America: Brave New World (2025)"]
  },
  {
    id: 1009156,
    name: "Ant-Man",
    ...
    powers: ["Manipulación de masa mediante Partículas Pym (micro a macro)", "Comunicación cibernética y control de colonias de hormigas", "Fuerza concentrada a escala insectil o de gigante", "Ingeniería electrónica"],
    stats: { intelligence: 4, strength: 2, speed: 2, durability: 2, energyProjection: 1, fightingSkills: 3 },
    thumbnail: { path: "https://i.annihil.us/u/prod/marvel/i/mg/7/50/5261a80a67e7d", extension: "jpg" },
    comicCover: "/images/antman-cover.png",
    notableComics: ["Marvel Premiere #47 (1979)", "Ant-Man: Second-Chance Man (2015)", "Astonishing Ant-Man (2015)"],
    mcuAppearances: ["Ant-Man (2015)", "Captain America: Civil War (2016)", "Avengers: Endgame (2019)"]
  },
  {
    id: 1009707,
    name: "Wasp",
    ...
    powers: ["Reducción de tamaño con alas bioeléctricas de alta velocidad", "Ráfagas bioeléctricas Sting letales", "Comunicación insectoide", "Liderazgo carismático y estratega de combate"],
    stats: { intelligence: 3, strength: 2, speed: 3, durability: 2, energyProjection: 4, fightingSkills: 4 },
    thumbnail: { path: "https://i.annihil.us/u/prod/marvel/i/mg/9/c0/5390dfa3424cb", extension: "jpg" },
    comicCover: "/images/wasp-cover.png",
    notableComics: ["Under Siege (Avengers #273-#277)", "Secret Invasion (2008)", "Uncanny Avengers (2012)"],
    mcuAppearances: ["Ant-Man and the Wasp (2018)", "Avengers: Endgame (2019)", "Quantumania (2023)"]
  },
  {
    id: 1009712,
    name: "War Machine",
    ...
    powers: ["Armadura táctica militar pesada con microcañón Gatling", "Misiles guiados 'Ex-Wife' y submuniciones perforantes", "Vuelo supersónico con reactores de combustible dual", "Entrenamiento de piloto y combate militar táctico"],
    stats: { intelligence: 3, strength: 6, speed: 5, durability: 6, energyProjection: 5, fightingSkills: 4 },
    thumbnail: { path: "https://i.annihil.us/u/prod/marvel/i/mg/5/60/537bb0c849187", extension: "jpg" },
    comicCover: "/images/warmachine-cover.png",
    notableComics: ["War Machine Vol 1 (1994)", "Iron Man: The Secret Origin of Tony Stark (2013)", "Civil War II (2016)"],
    mcuAppearances: ["Iron Man 2 (2010)", "Captain America: Civil War (2016)", "Avengers: Endgame (2019)"]
  },
  {
    id: 1009697,
    name: "Vision",
    ...
    powers: ["Manipulación de densidad molecular (desde intangible como humo hasta diamante ultra-denso)", "Rayo de energía solar a través de la gema frontal", "Fuerza y durabilidad cibernética sobrehumana", "Procesamiento computacional cuántico"],
    stats: { intelligence: 5, strength: 5, speed: 3, durability: 6, energyProjection: 6, fightingSkills: 3 },
    thumbnail: { path: "https://i.annihil.us/u/prod/marvel/i/mg/9/d0/5111527040594", extension: "jpg" },
    comicCover: "/images/vision-cover.png",
    notableComics: ["The Vision and the Scarlet Witch (1982)", "Vision by Tom King (2015)", "Avengers #57 (1968)"],
    mcuAppearances: ["Avengers: Age of Ultron (2015)", "Captain America: Civil War (2016)", "WandaVision (2021)"]
  },
  {
    id: 1010740,
    name: "Winter Soldier",
    ...
    firstAppearance: "Captain America Comics #1 (1941)",
    powers: ["Brazo biónico de titanio cibernético con fuerza sobrehumana e IEM", "Puntería de francotirador y artes marciales de asesinato", "Condicionamiento físico militar aumentado", "Especialista en guerra clandestina"],
    stats: { intelligence: 2, strength: 4, speed: 2, durability: 3, energyProjection: 1, fightingSkills: 6 },
    thumbnail: { path: "https://i.annihil.us/u/prod/marvel/i/mg/d/03/5265470ecae6a", extension: "jpg" },
    comicCover: "/images/wintersoldier-cover.png",
    notableComics: ["Captain America: Winter Soldier (2005)", "Captain America: The Death of Captain America (2007)", "Winter Soldier by Ed Brubaker (2012)"],
    mcuAppearances: ["The Winter Soldier (2014)", "Civil War (2016)", "Thunderbolts* (2025)"]
  },
  {
    id: 1011005,
    name: "Shang-Chi",
    ...
    powers: ["Maestría absoluta en todas las artes marciales del mundo", "Canalización y proyección del Chi vital", "Control místico de los Diez Anillos ancestrales", "Reflejos capaces de desviar ráfagas automáticas"],
    stats: { intelligence: 3, strength: 2, speed: 2, durability: 2, energyProjection: 1, fightingSkills: 7 },
    thumbnail: { path: "https://i.annihil.us/u/prod/marvel/i/mg/5/a0/5261a80a67e7d", extension: "jpg" },
    comicCover: "/images/shangchi-cover.png",
    notableComics: ["Master of Kung Fu #17-#125", "Shang-Chi: Brothers & Sisters (2020)", "Shang-Chi and the Ten Rings (2022)"],
    mcuAppearances: ["Shang-Chi and the Legend of the Ten Rings (2021)"]
  },
  {
    id: 1009583,
    name: "She-Hulk",
    ...
    powers: ["Fuerza gamma descomunal y resistencia titanio", "Intelecto legal y oratoria de primer nivel", "Ruptura habitual de la cuarta pared en los cómics", "Agilidad y flexibilidad atlética sobrehumana"],
    stats: { intelligence: 4, strength: 6, speed: 3, durability: 6, energyProjection: 1, fightingSkills: 4 },
    thumbnail: { path: "https://i.annihil.us/u/prod/marvel/i/mg/7/20/5261a80a67e7d", extension: "jpg" },
    comicCover: "/images/shehulk-cover.png",
    notableComics: ["The Sensational She-Hulk by John Byrne (1989)", "She-Hulk by Dan Slott (2004)", "She-Hulk by Rainbow Rowell (2022)"],
    mcuAppearances: ["She-Hulk: Attorney at Law (2022)"]
  },
  {
    id: 1009452,
    name: "Moon Knight",
    ...
    powers: ["Fuerza y reflejos modulados por las fases lunares", "Múltiples personalidades estratégicas (millonario, taxista, mercenario)", "Crecientes de adamantium y arsenal ceremonial egipcio", "Inmortalidad condicional como heraldo divino"],
    stats: { intelligence: 3, strength: 3, speed: 2, durability: 3, energyProjection: 1, fightingSkills: 6 },
    thumbnail: { path: "https://i.annihil.us/u/prod/marvel/i/mg/3/30/520288b9e59ed", extension: "jpg" },
    comicCover: "/images/moonknight-cover.png",
    notableComics: ["Moon Knight by Warren Ellis (2014)", "Moon Knight by Jeff Lemire (2016)", "Moon Knight by Jed MacKay (2021)"],
    mcuAppearances: ["Moon Knight Serie Disney+ (2022)"]
  },
  {
    id: 1009310,
    name: "Ghost Rider",
    ...
    powers: ["Mirada de Penitencia (hace sentir a la víctima todo el dolor infringido a otros)", "Control de Fuego Infernal místico destructivo", "Cadenas encantadas indestructibles de metal místico", "Hell Cycle capaz de escalar rascacielos y rodar sobre el agua"],
    stats: { intelligence: 2, strength: 4, speed: 3, durability: 5, energyProjection: 6, fightingSkills: 4 },
    thumbnail: { path: "https://i.annihil.us/u/prod/marvel/i/mg/3/80/52695b7cd21a1", extension: "jpg" },
    comicCover: "/images/ghostrider-cover.png",
    notableComics: ["Ghost Rider: Road to Damnation (2005)", "Trail of Tears (2007)", "Ghost Rider by Benjamin Percy (2022)"],
    mcuAppearances: ["Ghost Rider (2007)", "Agents of S.H.I.E.L.D. (2016)"]
  },
  {
    id: 1009515,
    name: "Punisher",
    ...
    powers: ["Maestro táctico militar, demoliciones y supervivencia extrema", "Puntería de nivel francotirador con todo tipo de armamento pesado", "Tolerancia inhumana al dolor físico y tortura", "Planificación estratégica de emboscadas letales"],
    stats: { intelligence: 3, strength: 3, speed: 2, durability: 2, energyProjection: 1, fightingSkills: 6 },
    thumbnail: { path: "https://i.annihil.us/u/prod/marvel/i/mg/3/90/5261a80a67e7d", extension: "jpg" },
    comicCover: "/images/punisher-cover.png",
    notableComics: ["The Punisher: Welcome Back, Frank (2000)", "Punisher MAX: Born (2003)", "Punisher MAX: The Slavers (2005)"],
    mcuAppearances: ["Daredevil Season 2 (2016)", "The Punisher Serie (2017-2019)", "Daredevil: Born Again (2025)"]
  },
  {
    id: 1009417,
    name: "Magneto",
    ...
    powers: ["Manipulación total de campos electromagnéticos globales", "Vuelo y generación de escudos de fuerza magnéticos impenetrables", "Manipulación de metales ferrosos y sangre a nivel atómico", "Resistencia psíquica gracias a su casco helmético"],
    stats: { intelligence: 5, strength: 2, speed: 4, durability: 2, energyProjection: 6, fightingSkills: 4 },
    thumbnail: { path: "https://i.annihil.us/u/prod/marvel/i/mg/3/b0/5261a7e53f827", extension: "jpg" },
    comicCover: "/images/magneto-cover.png",
    notableComics: ["God Loves, Man Kills (1982)", "Fatal Attractions (1993)", "House of M (2005)", "X-Men: Red (2022)"],
    mcuAppearances: ["X-Men (2000)", "X-Men: First Class (2011)", "X-Men: Days of Future Past (2014)"]
  },
  {
    id: 1009504,
    name: "Professor X",
    ...
    firstAppearance: "The X-Men #1 (1963)",
    powers: ["Telepatía de nivel Alfa/Omega global", "Control mental, posesión psíquica y borrado de memorias", "Generación de ilusiones mentales y pernos psíquicos letales", "Intelecto genio en genética y biofísica"],
    stats: { intelligence: 5, strength: 1, speed: 1, durability: 1, energyProjection: 5, fightingSkills: 3 },
    thumbnail: { path: "https://i.annihil.us/u/prod/marvel/i/mg/3/60/5261a80a67e7d", extension: "jpg" },
    comicCover: "/images/professorx-cover.png",
    notableComics: ["X-Men: Second Genesis (Giant-Size #1 1975)", "Onslaught (1996)", "House of X / Powers of X (2019)"],
    mcuAppearances: ["X-Men (2000)", "Doctor Strange in the Multiverse of Madness (2022)"]
  },
  {
    id: 1009356,
    name: "Jean Grey",
    ...
    firstAppearance: "The X-Men #1 (1963)",
    powers: ["Telepatía y telequinesis de nivel Omega", "Resurrección y transmutación cósmica mediante Phoenix Force", "Vuelo interestelar y manipulación de energía psiónica pura", "Control molecular de materia biológica"],
    stats: { intelligence: 3, strength: 2, speed: 3, durability: 2, energyProjection: 7, fightingSkills: 4 },
    thumbnail: { path: "https://i.annihil.us/u/prod/marvel/i/mg/f/d0/5261a80a67e7d", extension: "jpg" },
    comicCover: "/images/jeangrey-cover.png",
    notableComics: ["The Dark Phoenix Saga (1980)", "New X-Men by Grant Morrison (2001)", "Phoenix Resurrection (2018)"],
    mcuAppearances: ["X-Men (2000)", "X-Men: The Last Stand (2006)", "Dark Phoenix (2019)"]
  },
  {
    id: 1009257,
    name: "Cyclops",
    ...
    firstAppearance: "The X-Men #1 (1963)",
    powers: ["Rayos ópticos concusivos capaces de pulverizar montañas", "Genio estratega militar y líder de escuadrones de combate", "Conciencia espacial geométrica impecable", "Inmunidad a los poderes de sus hermanos Havok y Vulcan"],
    stats: { intelligence: 3, strength: 2, speed: 2, durability: 2, energyProjection: 5, fightingSkills: 4 },
    thumbnail: { path: "https://i.annihil.us/u/prod/marvel/i/mg/6/70/526547e2d90ad", extension: "jpg" },
    comicCover: "/images/cyclops-cover.png",
    notableComics: ["The Dark Phoenix Saga (1980)", "Astonishing X-Men by Joss Whedon (2004)", "Schism (2011)"],
    mcuAppearances: ["X-Men (2000)", "X-Men: Days of Future Past (2014)", "X-Men: Apocalypse (2016)"]
  },
  {
    id: 1009629,
    name: "Storm",
    ...
    powers: ["Manipulación climática atmosférica a escala planetaria", "Invocación de rayos, tornados, granizo y vendavales", "Vuelo aerodinámico mediante corrientes térmicas", "Resistencia psíquica formidable y combate con cuchillos"],
    stats: { intelligence: 2, strength: 2, speed: 3, durability: 2, energyProjection: 5, fightingSkills: 4 },
    thumbnail: { path: "https://i.annihil.us/u/prod/marvel/i/mg/6/40/5261a7d7c394b", extension: "jpg" },
    comicCover: "/images/storm-cover.png",
    notableComics: ["Lifedeath (Uncanny X-Men #186)", "X-Men: Worlds Apart (2008)", "X-Men: Red (2022)"],
    mcuAppearances: ["X-Men (2000)", "X-Men: Days of Future Past (2014)", "X-Men '97 (2024)"]
  },
  {
    id: 1009549,
    name: "Rogue",
    ...
    powers: ["Absorción táctil de memorias, energía vital y superpoderes", "Vuelo e invulnerabilidad permanente", "Fuerza sobrehumana colosal", "Adaptabilidad combativa polifacética"],
    stats: { intelligence: 2, strength: 4, speed: 3, durability: 4, energyProjection: 1, fightingSkills: 4 },
    thumbnail: { path: "https://i.annihil.us/u/prod/marvel/i/mg/3/10/5261a7e53f827", extension: "jpg" },
    comicCover: "/images/rogue-cover.png",
    notableComics: ["Uncanny X-Men #171 (1983)", "Rogue Vol 1 (1995)", "Mr. and Mrs. X (2018)"],
    mcuAppearances: ["X-Men (2000)", "X-Men: The Last Stand (2006)", "X-Men '97 (2024)"]
  },
  {
    id: 1009313,
    name: "Gambit",
    ...
    powers: ["Conversión de energía potencial en energía cinética explosiva", "Lanzamiento acrobático de naipes de baraja cargados", "Maestría en bōjutsu con vara de bo telescópica", "Encanto hipnótico biofísico sutil"],
    stats: { intelligence: 2, strength: 2, speed: 2, durability: 2, energyProjection: 4, fightingSkills: 5 },
    thumbnail: { path: "https://i.annihil.us/u/prod/marvel/i/mg/a/40/52696aa8a14f3", extension: "jpg" },
    comicCover: "/images/gambit-cover.png",
    notableComics: ["Gambit Vol 1 (1993)", "Mutant Massacre (1986)", "Deadpool & Wolverine (2024)"],
    mcuAppearances: ["X-Men Origins: Wolverine (2009)", "Deadpool & Wolverine (2024)"]
  },
  {
    id: 1009472,
    name: "Nightcrawler",
    ...
    firstAppearance: "Giant-Size X-Men #1 (1975)",
    powers: ["Teletransportación instantánea a través de la dimensión de azufre (BAMF)", "Fisiología acrobática con cola prensil y camuflaje en sombras", "Maestro esgrimista con doble estoque", "Adherencia a superficies verticales"],
    stats: { intelligence: 3, strength: 2, speed: 3, durability: 2, energyProjection: 1, fightingSkills: 4 },
    thumbnail: { path: "https://i.annihil.us/u/prod/marvel/i/mg/1/40/5261a80a67e7d", extension: "jpg" },
    comicCover: "/images/nightcrawler-cover.png",
    notableComics: ["Excalibur (1988)", "Nightcrawler by Roberto Sacasa (2004)", "Way of X (2021)"],
    mcuAppearances: ["X2: X-Men United (2003)", "X-Men: Apocalypse (2016)", "X-Men: Dark Phoenix (2019)"]
  },
  {
    id: 1009243,
    name: "Colossus",
    ...
    firstAppearance: "Giant-Size X-Men #1 (1975)",
    powers: ["Transformación completa en blindaje de acero osmio orgánico", "Fuerza colosal clase 100", "Invulnerabilidad casi absoluta al daño balístico y térmico", "Sin necesidad de respirar ni alimentarse en forma metálica"],
    stats: { intelligence: 2, strength: 6, speed: 2, durability: 6, energyProjection: 1, fightingSkills: 4 },
    thumbnail: { path: "https://i.annihil.us/u/prod/marvel/i/mg/6/e0/51127cf3e2e44", extension: "jpg" },
    comicCover: "/images/colossus-cover.png",
    notableComics: ["Uncanny X-Men: Mutant Massacre (1986)", "Astonishing X-Men: Gifted (2004)", "Fear Itself (2011)"],
    mcuAppearances: ["Deadpool (2016)", "Deadpool 2 (2018)", "Deadpool & Wolverine (2024)"]
  },
  {
    id: 1009459,
    ...
    powers: ["Elasticidad y deformación celular hiperplástica", "Intelecto omnidisciplinar nivel 12 (descubridor de la Zona Negativa)", "Invulnerabilidad a impactos contundentes y balísticos", "Creación de portales dimensionales y computación cósmica"],
    stats: { intelligence: 7, strength: 2, speed: 2, durability: 5, energyProjection: 1, fightingSkills: 3 },
    thumbnail: { path: "https://i.annihil.us/u/prod/marvel/i/mg/d/c0/5269657a74350", extension: "jpg" },
    comicCover: "/images/mrfantastic-cover.png",
    notableComics: ["The Galactus Trilogy (Fantastic Four #48-#50)", "Fantastic Four by Jonathan Hickman (2009)", "Secret Wars (2015)"],
    mcuAppearances: ["Fantastic Four (2005)", "Doctor Strange in the Multiverse of Madness (2022)", "The Fantastic Four: First Steps (2025)"]
  },
  {
    id: 1009366,
    ...
    firstAppearance: "The Fantastic Four #1 (1961)",
    powers: ["Invisibilidad óptica total y camuflaje de terceros", "Generación de campos de fuerza hipersólidos", "Vuelo por levitación sobre plataformas de energía invisible", "Capacidad de generar microcampos de fuerza internos letales"],
    stats: { intelligence: 3, strength: 2, speed: 2, durability: 5, energyProjection: 5, fightingSkills: 3 },
    thumbnail: { path: "https://i.annihil.us/u/prod/marvel/i/mg/6/a0/52695bce37484", extension: "jpg" },
    comicCover: "/images/invisiblewoman-cover.png",
    notableComics: ["Fantastic Four: Malice (1985)", "Fantastic Four #280-#284", "Secret Wars (2015)"],
    mcuAppearances: ["Fantastic Four (2005)", "Fantastic 4: Rise of the Silver Surfer (2007)", "The Fantastic Four: First Steps (2025)"]
  },
  {
    id: 1009351,
    name: "Human Torch",
    ...
    firstAppearance: "The Fantastic Four #1 (1961)",
    powers: ["Envoltura de plasma ígneo con vuelo supersónico", "Proyección y absorción de bolas de fuego", "Llama Nova (liberación térmica de más de un millón de grados)", "Inmunidad total al calor y combustión"],
    stats: { intelligence: 2, strength: 2, speed: 4, durability: 2, energyProjection: 5, fightingSkills: 3 },
    thumbnail: { path: "https://i.annihil.us/u/prod/marvel/i/mg/1/00/537bb26456f4e", extension: "jpg" },
    comicCover: "/images/humantorch-cover.png",
    notableComics: ["Fantastic Four #587 (Three Saga)", "Spider-Man & Human Torch (2005)", "Fantastic Four by Mark Waid (2002)"],
    mcuAppearances: ["Fantastic Four (2005)", "Deadpool & Wolverine (2024)", "The Fantastic Four: First Steps (2025)"]
  },
  {
    id: 1009662,
    name: "The Thing",
    ...
    firstAppearance: "The Fantastic Four #1 (1961)",
    powers: ["Fuerza bruta titánica clase 100", "Epidermis rocosa ultra-resistente inmune al fuego y artillería", "Luchador de boxeo callejero indestructible", "Voluntad indomable que nunca retrocede"],
    stats: { intelligence: 2, strength: 6, speed: 2, durability: 6, energyProjection: 1, fightingSkills: 5 },
    thumbnail: { path: "https://i.annihil.us/u/prod/marvel/i/mg/6/e0/5261a80a67e7d", extension: "jpg" },
    comicCover: "/images/thething-cover.png",
    notableComics: ["This Man... This Monster! (Fantastic Four #51)", "Marvel Two-in-One (1974)", "The Thing: Freakshow (2002)"],
    mcuAppearances: ["Fantastic Four (2005)", "Fantastic Four: Rise of the Silver Surfer (2007)", "The Fantastic Four: First Steps (2025)"]
  },
  {
    id: 1009281,
    name: "Doctor Doom",
    ...
    powers: ["Intelecto científico genio (creador de la Plataforma del Tiempo y Doombots)", "Hechicería arcana de nivel casi supremo", "Armadura de titanio imbuida de escudos de energía cósmica", "Voluntad férrea inmune al control mental y dolor"],
    stats: { intelligence: 6, strength: 4, speed: 2, durability: 5, energyProjection: 6, fightingSkills: 4 },
    thumbnail: { path: "https://i.annihil.us/u/prod/marvel/i/mg/3/60/53176bb096d17", extension: "jpg" },
    comicCover: "/images/doctordoom-cover.png",
    notableComics: ["Books of Doom (2005)", "Triumph and Torment (1989)", "Secret Wars (2015)"],
    mcuAppearances: ["Fantastic Four (2005)", "Avengers: Doomsday (2026)", "Avengers: Secret Wars (2027)"]
  },
  {
    id: 1010733,
    name: "Star-Lord",
    ...
    powers: ["Pistolas de Elementos cuádruples (fuego, agua, aire, tierra)", "Casco espacial con HUD táctico y soporte vital autónomo", "Botas cohete de aceleración antigravitatoria", "Estratega militar improvisador y piloto estelar"],
    stats: { intelligence: 3, strength: 2, speed: 2, durability: 2, energyProjection: 2, fightingSkills: 4 },
    thumbnail: { path: "https://i.annihil.us/u/prod/marvel/i/mg/9/a0/526547ec1512f", extension: "jpg" },
    comicCover: "/images/starlord-cover.png",
    notableComics: ["Annihilation: Conquest - Star-Lord (2007)", "Guardians of the Galaxy by Dan Abnett (2008)", "The Legendary Star-Lord (2014)"],
    mcuAppearances: ["Guardians of the Galaxy (2014)", "Avengers: Infinity War (2018)", "Guardians of the Galaxy Vol 3 (2023)"]
  },
  {
    id: 1010763,
    name: "Gamora",
    ...
    powers: ["Fuerza, agilidad y reflejos cibernéticamente aumentados", "Maestra en el 80% de estilos de combate armada y desarmada del cosmos", "Factor de curación aumentado", "Espada Godslayer capaz de cortar dioses"],
    stats: { intelligence: 3, strength: 3, speed: 3, durability: 3, energyProjection: 1, fightingSkills: 6 },
    thumbnail: { path: "https://i.annihil.us/u/prod/marvel/i/mg/5/90/5260321257f80", extension: "jpg" },
    comicCover: "/images/gamora-cover.png",
    notableComics: ["Warlock by Jim Starlin (1975)", "Infinity Watch (1992)", "Gamora: Memento Mori (2017)"],
    mcuAppearances: ["Guardians of the Galaxy (2014)", "Avengers: Infinity War (2018)", "Guardians of the Galaxy Vol 3 (2023)"]
  },
  {
    id: 1010744,
    ...
    powers: ["Genio de ingeniería armamentística y balística espacial", "Puntería de precisión táctica con armamento pesado", "Sentidos animales hipersensibles", "Estratega de combate y demolición"],
    stats: { intelligence: 4, strength: 2, speed: 2, durability: 2, energyProjection: 1, fightingSkills: 4 },
    thumbnail: { path: "https://i.annihil.us/u/prod/marvel/i/mg/9/b0/5261a80a67e7d", extension: "jpg" },
    comicCover: "/images/rocketraccoon-cover.png",
    notableComics: ["Rocket Raccoon Limited Series (1985)", "Annihilation: Conquest (2007)", "Rocket Raccoon by Skottie Young (2014)"],
    mcuAppearances: ["Guardians of the Galaxy (2014)", "Avengers: Endgame (2019)", "Guardians of the Galaxy Vol 3 (2023)"]
  },
  {
    id: 1010743,
    name: "Groot",
    ...
    powers: ["Regeneración completa a partir de una sola astilla o brote", "Manipulación de ramas, lianas espinosas y bioluminiscencia", "Fuerza titánica vegetal clase 100", "Elasticidad y ramificación táctica"],
    stats: { intelligence: 3, strength: 6, speed: 1, durability: 6, energyProjection: 1, fightingSkills: 4 },
    thumbnail: { path: "https://i.annihil.us/u/prod/marvel/i/mg/3/10/526033c10fba4", extension: "jpg" },
    comicCover: "/images/groot-cover.png",
    notableComics: ["Annihilation: Conquest (2007)", "Guardians of the Galaxy (2008)", "Groot Limited Series (2015)"],
    mcuAppearances: ["Guardians of the Galaxy (2014)", "Avengers: Infinity War (2018)", "Guardians of the Galaxy Vol 3 (2023)"]
  },
  {
    id: 1009592,
    ...
    powers: ["Poder Cósmico (manipulación de energía y materia subatómica)", "Vuelo a hipervelocidad más rápida que la luz", "Sentidos cósmicos omnipresentes y empatía astral", "Invulnerabilidad absoluta al vacío espacial y supernovas"],
    stats: { intelligence: 4, strength: 6, speed: 7, durability: 6, energyProjection: 6, fightingSkills: 4 },
    thumbnail: { path: "https://i.annihil.us/u/prod/marvel/i/mg/3/50/5269657a74350", extension: "jpg" },
    comicCover: "/images/silversurfer-cover.png",
    notableComics: ["The Galactus Trilogy (1966)", "Silver Surfer: Parable by Moebius & Stan Lee (1988)", "Silver Surfer: Requiem (2007)"],
    mcuAppearances: ["Fantastic Four: Rise of the Silver Surfer (2007)", "The Fantastic Four: First Steps (2025)"]
  },
  {
    id: 1009312,
    name: "Galactus",
    ...
    firstAppearance: "The Fantastic Four #48 (1966)",
    powers: ["Poder Cósmico absoluto de nivel cósmico primordial", "Creación de heraldos divinos y alteración de la realidad", "Inmortalidad y alteración de tamaño a escala colosal", "Conversión de energía planetaria"],
    stats: { intelligence: 7, strength: 7, speed: 7, durability: 7, energyProjection: 7, fightingSkills: 2 },
    thumbnail: { path: "https://i.annihil.us/u/prod/marvel/i/mg/5/03/537ba25608d08", extension: "jpg" },
    comicCover: "/images/galactus-cover.png",
    notableComics: ["The Coming of Galactus (1966)", "The Trial of Reed Richards (1982)", "Ultimates: Galactus Lifebringer (2016)"],
    mcuAppearances: ["Fantastic Four: Rise of the Silver Surfer (2007)", "The Fantastic Four: First Steps (2025)"]
  },
  {
    id: 1009323,
    ...
    powers: ["Fórmula del Duende (fuerza, resistencia y reflejos sobrehumanos)", "Planeador aerodeslizador artillado con cuchillas y misiles", "Bombas calabaza incendiarias y de gas somnífero", "Genio despiadado en química, finanzas y estrategia criminal"],
    stats: { intelligence: 5, strength: 4, speed: 3, durability: 4, energyProjection: 3, fightingSkills: 3 },
    thumbnail: { path: "https://i.annihil.us/u/prod/marvel/i/mg/5/e0/5261a80a67e7d", extension: "jpg" },
    comicCover: "/images/greengoblin-cover.png",
    notableComics: ["The Night Gwen Stacy Died (1973)", "Dark Reign (2008)", "Siege (2010)", "Red Goblin: Go Down Swinging (2018)"],
    mcuAppearances: ["Spider-Man (2002)", "Spider-Man: No Way Home (2021)"]
  },
  {
    id: 1009223,
    name: "Carnage",
    ...
    powers: ["Generación de armas blancas, hachas y espinas desde su propia biomasa", "Fuerza superior a Spider-Man y Venom combinados", "Capacidad de camuflaje y regeneración celular extrema", "Inmunidad parcial a ataques sónicos gracias a su enlace sanguíneo"],
    stats: { intelligence: 2, strength: 4, speed: 3, durability: 4, energyProjection: 1, fightingSkills: 4 },
    thumbnail: { path: "https://i.annihil.us/u/prod/marvel/i/mg/6/50/537ba313e6024", extension: "jpg" },
    comicCover: "/images/carnage-cover.png",
    notableComics: ["Maximum Carnage (1993)", "Carnage U.S.A. (2011)", "Absolute Carnage (2019)"],
    mcuAppearances: ["Venom: Let There Be Carnage (2021)"]
  }
];

const fileHeader = `export interface MarvelPowerGrid {
...
const outputPath = path.resolve(__dirname, '../src/data/marvelCharacters.ts');
let jsonBody = JSON.stringify(characters, null, 2);
jsonBody = jsonBody.replace(/"([a-zA-Z0-9_]+)":/g, '$1:');
const fullCode = fileHeader + jsonBody + ';\n';
fs.writeFileSync(outputPath, fullCode, 'utf8');

console.log(`Generated ${characters.length} canonical characters in ${outputPath}`);
